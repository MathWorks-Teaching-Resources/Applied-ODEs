...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Applied Ordinary Differential Equations';
            ...
            app.Image.ImageSource = 'PopulationGrowth.png';
            ...
            app.ReviewTitle.Text = 'Applied Ordinary Differential Equations';
